...
export function PlayersTable({ promises }: PlayersTableProps) {
  ...
  const [rowAction, setRowAction] =
    React.useState<DataTableRowAction<Player> | null>(null)
   ...
   */
  const filterFields: DataTableFilterField<Player>[] = [
    {
      id: "name",
      label: "Name",
    ...
    },
    {
      id: "status",
      label: "Status",
      options: players.status.enumValues.map((status) => ({
   ...
   */
  const advancedFilterFields: DataTableAdvancedFilterField<Player>[] = [
    {
      id: "name",
      label: "Name",
      type: "text",

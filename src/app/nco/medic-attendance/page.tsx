import MedicAttendanceTableContainer from "./_components/medic-attendance-table-container";

export default function MedicAttendancePage() {
    return (
            ...
            <div className="relative w-full bg-background border-b border-border overflow-hidden">
                ...
                <div className="relative container mx-auto px-4 py-10 text-center">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                        Log and review medic attendance for operations.
                    </p>
                </div>
            </div>

            <div className="container mx-auto px-4 py-8">
                <MedicAttendanceTableContainer />
            </div>
        </div>
    );
}